...
#define NUMBER_OF_INTERRUPTS_ONE_SECOND 31
extern volatile uint8 g_timeOut;
extern volatile uint8 count_sessionTime;
extern volatile bool g_timeIsUp;
extern volatile uint8 count_interrupts;
